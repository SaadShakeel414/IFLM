...
configurations = {
    1: dict(
        ...
        SEED = 1337,
        DATA_ROOT = 'D:/My_Research_Data/Datasets/Training/CASIA_train_Mixed/',
        MODEL_ROOT = '/', # the root to buffer your checkpoints
        LOG_ROOT = './', # the root to log your train/val status
        BACKBONE_RESUME_ROOT = './', # the root to resume training from a saved checkpoint
        HEAD_RESUME_ROOT = './', # the root to resume training from a saved checkpoint
        BACKBONE_NAME = 'IFLM', # support: ['ResNet_50', 'ResNet_101', 'ResNet_152', 'IR_50', 'IR_101', 'IR_152', 'IR_SE_50', 'IR_SE_101', 'IR_SE_152']
