...
def main(source_root):
    ...
    dest_root = "D:/My_Research_Data/Datasets/Testing/CALFW_reid_random_sunglasses/CALFW_reid_random_sunglasses/"
    mkdir(dest_root)
...
if __name__ == "__main__":
    min_side = 1
    main(source_root = "D:/My_Research_Data/Datasets/Testing/CALFW_reid_random_sunglasses/CALFW_reid_random_sunglasses/")