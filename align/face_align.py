...
if __name__ == '__main__':
    ...
    parser.add_argument("-source_root", "--source_root", help = "specify your source dir", default = "D:/My_Research_Data/Datasets/Testing/Sunglasses_Occluded/CALFW_reid_random_sunglasses/CALFW_reid_random_sunglasses/", type = str)
    parser.add_argument("-dest_root", "--dest_root", help = "specify your destination dir", default = "D:/My_Research_Data/Datasets/Testing/Sunglasses_Occluded/CALFW_reid_random_sunglasses_aligned/", type = str)
